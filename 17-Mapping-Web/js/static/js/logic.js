...
function markerSize(feature) {
  return Math.sqrt(Math.abs(feature.properties.mag)) * 6;
}
...
d3.json(queryUrl, function(data) {
    ...
    var earthquakes = L.geoJSON(data, {
        ...
        onEachFeature: function (feature, layer) {
          return layer.bindPopup(`<strong>Location:</strong> ${feature.properties.place}<br><strong>Magnitude:</strong> ${feature.properties.mag}`);
        }
      });
